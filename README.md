...
- [🚗 Tabela Fipe](https://github.com/cafecomlucas/mobiauto/tree/main/tabela-fipe-app): Aplicação em Next.js (App Router), feita para consultar a API da tabela FIPE, atualizar os campos dinâmicamente e exibir preços de compra de carros baseado na Marca, Modelo e Ano selecionados. Feito com Next.js (App Router).
